                ...
                <div class="panel-heading">Cadastro de Usuário</div>
                  <div class="panel-body">
                    ...
                    <label class="col-md-2 control-label" for="textinput">Senha: <h11>*</h11></label>
                      <div class="col-md-2">
                        <input id="senha2" name="senha2" placeholder="" class="form-control input-md" type="password">
                         <input id="senha" name="senha" placeholder="" class="form-control input-md" type="hidden">
                      </div>
                  </div>
